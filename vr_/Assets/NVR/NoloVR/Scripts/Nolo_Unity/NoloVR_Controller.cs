...
public class NoloVR_Controller {
    ...
    private static Vector3 recPosition = Vector3.zero;
    ...
    public class NoloDevice
    {
        ...
        {
            return new Vector2(controllerStates.touchpadAxis.x - preControllerStates.touchpadAxis.x, controllerStates.touchpadAxis.y - preControllerStates.touchpadAxis.y);
        }
    ...
    private static float real_yaw = 0;
